			...
			<section className="content-sign-out">
				...
				>
					...
					<section className="social-btns">
						...
						<a href="https://" className="socialContainer containerOne">
							<svg
						...
						<a href="https://" className="socialContainer containerTwo">
							<svg
						...
						<a href="https://" className="socialContainer containerThree">
							<svg
						...
						<a href="https://" className="socialContainer containerFour">
							<svg
