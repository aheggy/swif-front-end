...
// We can activate this component by using the route:  <Route path="/signedout" element={<SignedOut />}/>
// in the App.js file
		...
		<div className="signout-page">
			<section className="content-sign-out">
				...
				>
					...
					<div className="card">
						<a href="https://urlinstagram" className="socialContainer containerOne">
							<svg
						...
						<a href="https://urltwitter" className="socialContainer containerTwo">
							<svg
						...
						<a href="https://urllinkdin" className="socialContainer containerThree">
							<svg
						...
						<a href="https://urlwhatsapp" className="socialContainer containerFour">
							<svg
